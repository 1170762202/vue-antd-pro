    ...
    <section class="main">
        <div class="container">
            ...
            <div class="drag-box">
                ...
                <div>
                    <pre-wrap>{{todoJson}}</pre-wrap>
                </div>
                <div style="margin-left: 10px">
                    <pre-wrap>{{doingJson}}</pre-wrap>
                </div>
                <div style="margin-left: 10px">

                <pre-wrap>{{doneJson}}</pre-wrap>
                </div>
            </div>
        </div>
    </section>
...
<script>
    ...
    export default {
        ...
        methods: {
            initData() {
                this.doingJson = JSON.stringify(this.doing)
                this.todoJson = JSON.stringify(this.todo)
                this.doneJson = JSON.stringify(this.done)
            },
            removeHandle(event) {
                // console.log('event', JSON.stringify(this.doing));
